...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("../../magic-string.es-GGZQ22EI.mjs")).default;
...
// src/routes/event/create-event.spec.ts
test("Create an event", () => {
  const fakeEvent = {
    ...
    limitDateToSubscribe: /* @__PURE__ */ new Date()
  };
  globalExpect(fakeEvent.maximunAtendees).toBeFalsy();
});
